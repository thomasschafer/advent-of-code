...
pathsCross lower' upper' ((px1', py1', _), (vx1', vy1', _)) ((px2', py2', _), (vx2', vy2', _))
  | vx1 == vx2 && vy1 == vy2 || vx1 * vy2 == vx2 * vy1 = (px1, py1) == (px2, py2)
  | otherwise = k1 >= 0 && k2 >= 0 && all (\c -> c >= lower && c <= upper) [xCrossing, yCrossing]
  where
    [px1, py1, vx1, vy1, px2, py2, vx2, vy2, lower, upper] = map toRational [px1', py1', vx1', vy1', px2', py2', vx2', vy2', lower', upper']
